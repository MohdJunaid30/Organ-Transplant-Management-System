...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "</table>";
  echo '<h3>To initiate the transplantation process for the above matches</h3>';
  echo '<a href="http://localhost/organ_transplant1/trans1.php" target="_self" class="button">Click Here</a>';
